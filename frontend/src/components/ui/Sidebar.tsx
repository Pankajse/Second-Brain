    ...
    <>
      ...
      <div
        className={`
            ...
            lg:sticky lg:translate-x-0 lg:w-74 lg:top-0 flex-col flex justify-between
          `}
      >
        <div>
        ...
        <div className="mb-5 w-full flex justify-center">
          <Button variant="destructive" size="full" text="Log out" onClick={() => { localStorage.removeItem("token"); navigate('/') }}></Button>
        </div>
      </div>
